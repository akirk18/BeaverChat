...
using BeaverChat.Core.EventHandlers;
using Microsoft.AspNetCore.SignalR.Client;

namespace BeaverChat.Core
{
    public class ChatService
    {
        public EventHandler<MessageEventArgs> OnRecieveMessage;
        public EventHandler<MessageEventArgs> OnEnteredOrExited;
        public EventHandler<MessageEventArgs> OnConnectionClosed;
        ...
        public void Init(string urlRoot, bool useHttps)
        {
            ...
            {
                OnRecieveMessage?.Invoke(this, new MessageEventArgs(message, user));
            });
